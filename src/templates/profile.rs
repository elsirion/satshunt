...
fn location_card_content(location: &Location, max_sats_per_location: i64, withdrawable_sats: i64, sats_percent: i32) -> Markup {
    html! {
            ...
            div class="pt-4" style="border-top: 3px solid var(--accent-muted);" {
                @if location.is_active() {
                    a href={"/locations/" (location.id)}
                        class="btn-brutal text-center w-full block" {
